...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { applicants: @opportunity.applicants, area: @opportunity.area, body: @opportunity.body, country: @opportunity.country, end_date: @opportunity.end_date, latitude: @opportunity.latitude, longitude: @opportunity.longitude, name: @opportunity.name, recruiter_id: @opportunity.recruiter_id, start_date: @opportunity.start_date, status: @opportunity.status }
    end
  ...
  test "should update opportunity" do
    put :update, id: @opportunity, opportunity: { applicants: @opportunity.applicants, area: @opportunity.area, body: @opportunity.body, country: @opportunity.country, end_date: @opportunity.end_date, latitude: @opportunity.latitude, longitude: @opportunity.longitude, name: @opportunity.name, recruiter_id: @opportunity.recruiter_id, start_date: @opportunity.start_date, status: @opportunity.status }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
